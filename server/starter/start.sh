...
CLEAR_FAIROS="sudo rm -r /Users/sdancer/.fairOS/dfs-test && mkdir /Users/sdancer/.fairOS/dfs-test"
CLEAR_BEE="ssh pi@raspberrypi.local -t 'sudo systemctl stop beetest && sudo rm -r /var/lib/bee-test/localstore/ && sudo systemctl start beetest'"
